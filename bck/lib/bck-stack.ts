      ...
      buildSpec: CodeBuild.BuildSpec.fromObject({
        ...
        phases: {
          install: {
            ...
            commands: [
              'cd 13C-Virtual-Lolly-FrontEnd-and-Backend',
              'cd client',
              'npm i -g gatsby',
              'npm install',
            ],
        ...
        artifacts: {
          'base-directory': './13C-Virtual-Lolly-FrontEnd-and-Backend/client/public',   ///outputting our generated Gatsby Build files to the public directory
          "files": [
            '**/*'
          ]
        },
